...
<div align = "center" class = "container">
			...
			<table style = "margin-left: auto;margin-right: auto">
				...
				<!-- Insert User type -->
				<tr>
					<td>User Type <select name = "usertype"><option>Admin</option><option>Kiosk Participant</option><option>FK Technical Team</option><option>Pupuk Admin</option><option>FK Bursary</option></select></td>
				</tr>
				<tr>
